...
public class MKPGlassFrame extends JFrame {
    ...
    public static float CONFIGURED_GLASS_OPACITY = 0.4f;
	...
	BufferedImage image = bi.getImage();
	pad_.setBackgroundImage(image);
    }
	...
	pad_.highLightController_.clear();
	pad_.drawController_.clear();
    }
