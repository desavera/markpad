  ...
  public void paintComponent(Graphics g){
	...
	if (parentFrame_.getGlassState() == MKPGlassFrame.INIT_GLASS_STATE) {
		...
		try {                
			...
			System.err.println("NO BACKGRD IMAGE ! ");
       		}
	...
	public void mouseReleased(MouseEvent e) {
		...
		if (pane_.parentFrame_.getGlassState() == MKPGlassFrame.INIT_GLASS_STATE) {
			...
			pane_.parentFrame_.setSize(point2_.x - point1_.x,
        		...
        		int x_mid = Toolkit.getDefaultToolkit().getScreenSize().width/2;
			int y_mid = Toolkit.getDefaultToolkit().getScreenSize().height/2;

			//pane_.parentFrame_.setLocation(x_mid - pane_.parentFrame_.getWidth()/2,y_mid - pane_.parentFrame_.getHeight()/2 );
			pane_.parentFrame_.setLocation(x_loc_onscr - pane_.parentFrame_.getWidth(),y_loc_onscr - pane_.parentFrame_.getHeight());
