...
public class MKPGlassPane extends JPanel {
  ...
  public MKPGlassPane(MKPGlassFrame parentFrame) {
       ...
       // by default starts with HIGHLIGHT_MODE
       setMarkMode(HIGHLIGHT_MODE);
  }
 ...
 @Override
  ...
  public void scrCapture() {
	...
	backgroundImage_ = new SerializableBufferedImage(robot.createScreenCapture(parentFrame_.getBounds()));
