 ...
 */
@WebListener
public class RPnMasterReqProxy extends RPnMediatorProxy {
    ...
    public static String TOPIC_NAME = RPnNetworkStatus.RPN_MASTER_REQ_TOPIC_NAME;
            ...
            responseErrorMsg(response,WRONG_INPUT_ERROR_MSG);
              ...
              //  if (subsDatalog_.containsKey(clientId)) {
                    ...
                    while (!msgQueue.isEmpty()) {
                        ...
                        // for DEBUGING
                        System.out.println("Message received at RPnMasterReqProxy : " + '\n' + command);
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        System.out.println("Will now listen to : " + RPnNetworkStatus.RPN_MASTER_REQ_TOPIC_NAME);
        subscriber_ = new RPnProxySubscriber(RPnNetworkStatus.trimLocalJmsPrefix(RPnNetworkStatus.RPN_MASTER_REQ_TOPIC_NAME),
