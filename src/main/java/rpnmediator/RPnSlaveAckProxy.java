 ...
 */
@WebListener
public class RPnSlaveAckProxy extends RPnMediatorProxy {
    ...
    public static String TOPIC_NAME = RPnNetworkStatus.RPN_SLAVE_ACK_TOPIC_NAME;
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        System.out.println("Will now listen to : " + RPnNetworkStatus.RPN_SLAVE_ACK_TOPIC_NAME);
        subscriber_ = new RPnProxySubscriber(RPnNetworkStatus.trimLocalJmsPrefix(RPnNetworkStatus.RPN_SLAVE_ACK_TOPIC_NAME),
